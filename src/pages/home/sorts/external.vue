        ...
        <el-card>
          <div slot="header" class="header">
            ...
            <div class="check-group">
              <el-select v-model="statusType" placeholder="审核状态分类">
              ...
              <el-table-column type="expand">
                <template slot-scope="props">
                  <el-form label-position="left" class="table-expand">
                    <el-form-item v-if="props.row.status == '4' || props.row.status == '5'" label="审核未通过原因">
  ...
  data() {
    ...
    return {
      ...
      statusTypes: [
        ...
        {value: '4', label: '商户创建审核失败'},
        {value: '5', label: '商户物料审核失败'}
      ],
      labelPosition: "left",
