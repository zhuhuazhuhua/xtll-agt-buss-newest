...
export default {
  ...
  methods: {
    ...
    getProvinces() {
      ...
      // if (this.ruleForm.agtClass == "2" || this.ruleForm.agtClass == "3" || this.ruleForm.userType != "2") {
      $.each(this.provinceOptions, (index, item) => {
        ...
        item.children = secondData.map(second => {
          // if (this.ruleForm.agtClass == "3" || this.ruleForm.userType != "2") {
          return {
